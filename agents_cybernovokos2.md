...
- **2026-06-13**: Улучшена отзывчивость мульти-хиро блока (`HeroNew.tsx`) к скроллу на мобильных устройствах за счет уменьшения высоты scroll-контейнера (`h-[300svh]`). Добавлена интуитивная анимация-подсказка с рукой и стрелками для свайпа зон в компоненте `ZonesPreview.tsx`, а текст "Свайпай или жми" оформлен в виде заметной пульсирующей кнопки на мобильных устройствах.
