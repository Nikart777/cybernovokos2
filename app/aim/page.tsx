...
export default function AimGamePage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white overflow-hidden flex flex-col relative font-sans select-none overscroll-none">
      ...
      {/* HIDDEN SEO CONTENT */}
      <h1 className="sr-only">CyberX Новокосино - Мини-игра Aim God (Тренировка аима)</h1>
      <p className="sr-only">Играйте в Aim God, улучшайте свои навыки стрельбы и выигрывайте бонусы в лучшем компьютерном клубе Новокосино.</p>
      ...
      <header className="relative z-20 flex items-center justify-between px-4 md:px-8 py-4 border-b border-white/10 bg-[#050505]/80 backdrop-blur-md">
        <Link href="/" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors group">
          ...
          <span className="font-chakra font-bold text-xs md:text-sm uppercase tracking-widest hidden sm:inline">Вернуться в клуб</span>
        </Link>
