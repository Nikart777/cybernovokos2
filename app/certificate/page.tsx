...
export const metadata: Metadata = {
  title: "Купить подарочный сертификат в компьютерный клуб",
  description: "Купить подарочный сертификат в компьютерный клуб CyberX Новокосино: электронный сертификат на любой номинал для парня, друга или коллеги. Москва, ул. Новокосинская, 32.",
  alternates: {
    canonical: "https://cyberx-novokosino.ru/certificate",
  },
  keywords: "купить сертификат в компьютерный клуб, подарочный сертификат компьютерный клуб, подарок парню, что подарить мужчине, оригинальный подарок парню, подарок на 23 февраля парню, подарок на день рождения парню, сертификат",
};
