        ...
        return (
            <div className="relative overflow-hidden bg-[#0F1419]/95 backdrop-blur-xl p-8 rounded-[2rem] border border-[#00ff88]/50 shadow-[0_0_50px_rgba(0,255,136,0.15)] text-center animate-in fade-in zoom-in duration-300">
                ...
                <p className="text-xs text-gray-400 mt-4 font-inter text-center leading-relaxed">
                    ...
                    РёР»Рё РІ РїСЂРёР»РѕР¶РµРЅРёРё <a href="/download" target="_blank" rel="nofollow noopener noreferrer" className="text-[#00ff88] font-tactic italic hover:underline">CYBERX</a> (РІС‹Р±РµСЂРёС‚Рµ CYBERX РЅРѕРІРѕРєРѕСЃРёРЅРѕ)
                </p>
            </div>
        );
    }
