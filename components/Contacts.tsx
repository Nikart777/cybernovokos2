        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           >
              ...
              <iframe 
                ...
                allowFullScreen 
                loading="lazy"
                title="Карта проезда к CyberX Новокосино"
              />
           </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4">
                 ...
                 <div className="flex gap-2">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer nofollow" 
                      className="flex-1 bg-[#1a1a1a] border border-white/10 rounded-2xl flex items-center justify-center text-white hover:bg-[#0088cc] hover:border-transparent transition-colors"
                      aria-label="Telegram"
                    >
                       <Send size={24} />
                    </a>
                    <a 
                      href="https://vk.com/club224403383" 
                      target="_blank" 
                      rel="noopener noreferrer nofollow"
                      className="flex-1 bg-[#1a1a1a] border border-white/10 rounded-2xl flex items-center justify-center text-white hover:bg-[#0077FF] hover:border-transparent transition-colors"
