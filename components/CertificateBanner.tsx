            ...
            <div className="container mx-auto max-w-7xl">
                <Link href="/certificate" className="block w-full group">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="relative w-full rounded-3xl overflow-hidden bg-[#FF2E63] p-5 sm:p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-10 shadow-[0_0_80px_rgba(255,46,99,0.4)] transition-[box-shadow] duration-500 hover:shadow-[0_0_100px_rgba(255,46,99,0.6)] group"
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left w-full md:w-3/5">
                            ...
                            <h2 className="text-3xl min-[380px]:text-4xl sm:text-5xl md:text-[3rem] lg:text-[4rem] xl:text-[4.5rem] font-tactic italic uppercase font-black tracking-tighter text-[#0a0f1a] leading-[0.85] mb-6 w-full text-balance">
                            ...
                            <p className="text-[#0a0f1a] font-inter text-base md:text-lg font-bold max-w-md text-pretty">
                        ...
                        <div className="relative z-10 shrink-0 mt-8 md:mt-0 w-full md:w-2/5 flex flex-col items-center">
                            <div className="relative flex items-center justify-center w-64 h-40 md:w-80 md:h-52 mb-8 md:mb-0">
                                ...
                                <div className="absolute inset-0 bg-[#0a0f1a] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] transform -rotate-6 group-hover:-rotate-2 group-hover:scale-105 transition-transform duration-500 flex flex-col p-6 overflow-hidden z-20">
                                ...
                                {/* Second Card behind */}
                                <div className="absolute inset-0 bg-black/40 rounded-2xl transform rotate-3 group-hover:rotate-6 group-hover:scale-[0.96] transition-transform duration-500 z-10 blur-[2px]"></div>
                            </div>
                        </div>

                        {/* Mobile Button */}
                        <div className="relative z-10 md:hidden mt-4 w-full">
                            <div className="w-full flex justify-center items-center gap-3 bg-[#0a0f1a] text-white px-8 py-5 rounded-2xl font-tactic italic font-black uppercase tracking-widest text-lg active:scale-[0.96] transition-transform duration-150 ease-out">
                                Оформить
                                <ArrowRight size={24} />
                            </div>
                        </div>
                        ...
                        {/* Desktop Button */}
                        <div className="absolute right-8 bottom-8 z-30 hidden md:flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-[#0a0f1a] text-white transform opacity-90 hover:opacity-100 transition-[transform,opacity,box-shadow] duration-300 hover:scale-105 active:scale-[0.96] shadow-xl hover:shadow-2xl">
